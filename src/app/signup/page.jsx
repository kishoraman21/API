    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-22 h-18 bg-transparent mb-4">
            <img src={logo.src} alt="ApiDeck Logo" />
          </div>
          <h1 className="text-3xl font-bold text-white mb-2">Create Account</h1>
          <p className="text-slate-400">
            Sign up for your Api Analytics account
          </p>
        </div>
        ...
        <div className="bg-slate-900/50 backdrop-blur-sm border border-slate-800 rounded-2xl p-8 shadow-2xl">
          ...
          <p className="text-sm text-slate-400 text-center mt-6">
            ...
            <a
              ...
              className="text-orange-400 hover:text-orange-300 font-medium transition-colors font-semibold"
            >
              Sign In
            </a>
          </p>
